#Aula 14 - Quebra Estrutural e Bolhas ~ Econometria Avançada

install.packages("strucchange")                       #Instalando o pacote "strucchange" para desenvolver as analises de quebra estratural.

library(strucchange)                                  #Carregando o pacote "strucchange"
...
#Teste de Chow # Testa se os coeficientes de duas regressões de diferentes conjuntos de dados são iguais

chow <- Fstats(Bitcoin~1)    #Comando para executar o Teste de F de Chow
...
#Teste Bai Perron #Utilizado para testar as quebras estruturais
